...
program.option("-c, --credential <name>=<value>", "credential parameter for service-create", parseOption, {});
program.option("-o, --option <name>=<value>", "option for service-create", parseOption, {})
